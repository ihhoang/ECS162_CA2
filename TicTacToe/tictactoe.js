...
function restartGame() {
    ...
    currentPlayer = 'X';
    gameState = ["", "", "", "", "", "", "", "", ""];
    document.getElementById('instText').innerText = "Player X's turn";
    cells.forEach(cell => {
        cell.innerHTML = "";
...
function updateGameStatus() {
    ...
    if (result) {
        gameActive = false;
        if (result === 'tie') {
            document.getElementById('instText').innerText = "Game Draw!";
        } else {
            document.getElementById('instText').innerText = `Player ${result} Wins!`;
        }
    } else {
        togglePlayer();
    }
...
function togglePlayer() {
    ...
    document.getElementById('instText').innerText = "Player " + currentPlayer + "'s turn";
